...
impl ReportGenerator {
    ...
    pub fn carbon_report_pdf(&self, data: &CarbonReportData, path: &str) -> GeoResult<()> {
        ...
        y -= 4.0;
        write_line!(&format!("AOI: {}   Year: {}", data.aoi_name, data.year), font_size);
        ...
        write_line!(&format!("Landcover Classes: {}", data.breakdown.len()), font_size);
        y -= 4.0;
        ...
        for audit in &data.audit_trails {
            ...
            write_line!(
                &format!(
                    "  {} — {} — {}",
                    audit.class, audit.factor_hash, status
                ),
                font_size
            );
        }
