...
pub fn register_tools(registry: &mut PluginRegistry) {
    registry.register(geo_core::plugin::PluginMeta { name: "energy".into(), version: "0.1.0".into(), description: "Solar/wind site suitability assessment".into(), category: PluginCategory::Process, healthy: true, extra: serde_json::json!({}) });
