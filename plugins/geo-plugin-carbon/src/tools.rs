...
pub fn register_tools(registry: &mut PluginRegistry) {
    registry.register(geo_core::plugin::PluginMeta { name: "carbon".into(), version: "0.1.0".into(), description: "IPCC Tier 1 carbon accounting".into(), category: PluginCategory::Carbon, healthy: true, extra: serde_json::json!({}) });
