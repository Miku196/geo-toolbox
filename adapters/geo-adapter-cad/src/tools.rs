...
pub fn register_tools(registry: &mut PluginRegistry) {
    registry.register(geo_core::plugin::PluginMeta { name: "cad".into(), version: "0.1.0".into(), description: "CAD format exporter: GeoJSON from PostGIS".into(), category: PluginCategory::Output, healthy: true, extra: serde_json::json!({}) });
