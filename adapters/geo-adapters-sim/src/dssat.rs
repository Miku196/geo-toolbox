...
// ════════════════════════════════════════════════════════════════
// Trait implementation: geo_core::traits::DssatGenerator
// ════════════════════════════════════════════════════════════════
...
impl DssatGenerator for DssatAdapter {
    ...
    fn generate_sol(&self, profile: &CoreSoilProfile) -> String {
    ...
    fn generate_cul(&self, params: &CoreCultivarParams) -> String {
        generate_cul(&CultivarParams {
            cultivar_name: params.cultivar_name.clone(),
            ecotype: params.ecotype.clone(),
            p1: params.p1,
            p2: params.p2,
            p5: params.p5,
            g2: params.g2,
